...
class Flower(object):
    ### this is key of visitor pattern ###
    # Flower's accept method, to accept a visitor
    # and let visitor do sth on me
...
# vistor have ability, and determine its logic to access Flower.
